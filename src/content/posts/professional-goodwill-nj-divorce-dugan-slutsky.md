...
The trial judge found it incredible that a firm of that stature had no goodwill. He rejected the husband's expert, adopted the wife's original figure — including calculations her own expert had conceded were wrong and revised downward on redirect — and awarded half.

The Appellate Division reversed. The error was not arithmetic. It was that the judge had answered a question nobody asked.

## Earning capacity is not property. Goodwill is.
...
Goodwill, the Court held, is "essentially reputation that will probably generate future business." It captures the advantages of an established business that contribute to profitability — a good name, capable staff, a reputation for superior service. Then the sentence that governs every case since:
...
The inability to sell changed nothing. Equitable distribution has never required conveyance of any particular asset. After the divorce the practice keeps the benefit of goodwill built during the marriage, and the non-attorney spouse helped build it.

The Court also named the equity problem it was creating. The titled spouse is "forced to pay the ex-spouse 'tangible' dollars for an intangible asset." That sentence is the seed of everything that has narrowed the doctrine since.
...
The Court built in a warning that experts still walk past. A sole practitioner working a regular sixty-hour week will out-earn a forty-hour employee. That gap is productivity, not reputation. Effort is not goodwill. Neither is a specialty premium the market pays to any competent specialist.

*Dugan* was explicit that the method is not exclusive. Where the practitioner holds an interest governed by a partnership or shareholder agreement, the agreement may be the better measure.

## The line New Jersey draws without naming it

Most states now sort goodwill into two buckets. Enterprise goodwill attaches to the business and survives the owner's departure. Personal goodwill is the owner's own reputation and skill, inseparable from him. A clear majority treat the first as marital property and the second as earning capacity relevant to support.

New Jersey has never adopted that vocabulary. No published decision makes personal-versus-enterprise the governing test.

It does not need to. The reasonable-compensation deduction performs the same function. When the appraiser subtracts what a comparably credentialed employee would earn for the same hours, what he is subtracting is personal goodwill — the value of the practitioner's own labor. Whatever survives the subtraction is, by construction, value the enterprise produces independent of him. *Levy* said as much before *Dugan*: what is measured is "the capacity of repeat patronage and of a certain immunity to competition to produce earnings beyond the average for that kind of business."
...
Where a partnership or shareholder agreement fixes value, *Stern* attached a presumption most practitioners overlook. Once it is established that the firm's books are well kept and that partners' interests are in fact periodically and carefully reviewed, the agreement's valuation "should be subject to effective attack only upon the submission of clear and convincing proofs." *Slutsky* reaffirmed it and directed the trial court to test the objectiveness and accuracy of the firm's formula.

That cuts both ways, and it is leverage either way. Counsel for the titled spouse should build the record on bookkeeping quality and periodic review before the appraisers ever testify. Counsel attacking the formula needs to know the standard is clear and convincing rather than preponderance, and needs a theory of why the formula is not objective — usually that it was designed to suppress payouts to departing partners rather than to measure value.

The buyout side of the practice supplies the mirror image. In [*Namerow v. PediatriCare Associates, LLC*](/authorities/namerow-v-pediatricare-461-nj-super-133/), 461 N.J. Super. 133 (Ch. Div. 2018), an unambiguous valuation provision was enforced as written, and sixteen years of contrary practice did not modify it. Agreements govern until someone proves they should not.

## Standard of value, discounts, and the double-dip

[*Brown v. Brown*](/authorities/brown-v-brown-348-nj-super-466/), 348 N.J. Super. 466 (App. Div.), certif. denied, 174 N.J. 193 (2002), fixed the matrimonial standard at fair value rather than fair market value and held that marketability and minority discounts should not apply absent extraordinary circumstances. The reasoning is contextual. In equitable distribution no shares transfer and no sale is coming, so the illiquidity a hypothetical buyer would price is not being borne by anyone.
...
## A premise that quietly dissolved
...
## Where these reports break

A goodwill opinion in a New Jersey matrimonial case fails in predictable places.

Reasonable compensation drawn from a survey median without adjustment. *Dugan* requires comparison to a lawyer of similar education, experience, expertise, and age, working similar hours, in the same locale. Both experts in *Slutsky* used the same published survey of law firm economics and reached opposite conclusions, which tells you the survey is an input and not an answer.

Hours never normalized. The sixty-hour practitioner problem is in the opinion. If the report does not address it, say so.

A capitalization factor asserted rather than derived. Age, competitive intensity, and the mortality of the goodwill all move the multiple, and the report should show the work.

Firm goodwill imputed to the individual. After *Slutsky* this is reversible error, not a weak inference.

Projections that contradict the governing documents. Retirement age, mandatory senior status, subordination of capital accounts, and buyout formulas are all in the agreement. Read it before modeling.

No covenant analysis. A buyer of a practice expects a covenant not to compete, and the appraiser is implicitly assuming one. Where no covenant exists or none is enforceable, the value comes down.

The analysis does not stay in the matrimonial part. Excess earnings, normalized compensation, and the boundary between the enterprise and the individual decide shareholder buyouts, key-man discounts, and fair-value appraisals in oppression and dissenters' rights cases. The caption changes. The question does not: what is this business worth when the person who built it walks out the door?

---

## Frequently asked questions

**Is goodwill in a professional practice always subject to equitable distribution in New Jersey?**
...
**If you are valuing a professional practice in a divorce or a buyout and the goodwill number is the case, I serve as special valuation counsel to owners and their attorneys.** [Schedule a strategy call](https://outlook.office.com/bookwithme/user/e3152abf19db458089a2e936b0082b49@sh-law.com/meetingtype/GAHEBwyjuU6fohpaycDa7w2?anonymous&ismsaljsauthenabled&ep=mlink)
