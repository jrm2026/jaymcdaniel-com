...
The case is unpublished and therefore not precedential; cite it for its illustrative force, not as controlling authority, and pair it with the published discretion in *Balsamides* and *Lawson Mardon Wheaton*. The practical takeaway is defensive: fight marketability on economics — comparable data, restricted-stock studies — because a discount defended on the numbers survives, while one defended by how badly the other side behaved is available in New Jersey but discretionary, fact-bound, and unlikely to travel.
